...
Purpose : Matches companies using LLM and scoring matrix. Receives OpenAIClient via Dependency Injection.
Version : 1.3.1
...
class CompanyMatchAgent:
    ...
    def run(
        ...
        payload = {
            "matched_companies": first_message,
        }
        meta = {
            "base_name": base_name,
            "iteration": iteration,
